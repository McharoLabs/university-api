#!/bin/bash
# health_check.sh
# Monitors CPU, memory, disk space, Nginx status, and your university API
...
# Web server and API setup
WEB_SERVER="nginx"
API_ENDPOINTS=(
    "https://cs.ua.seranise.co.tz/api/students/"
    "https://cs.ua.seranise.co.tz/api/subjects/"
)
